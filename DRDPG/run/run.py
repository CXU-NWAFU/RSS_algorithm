...
import torch
from agents.DRDPG import DRDPG_Agent


def add_argparse():
    parser = argparse.ArgumentParser(description='parameters')
    parser.add_argument('--exp_name', default='DRDPG', type=str)

    parser.add_argument("--Ehp", default=0.2, type=float)
    parser.add_argument("--ADM", default=0, type=int)
    ...
    parser.add_argument("--seq_del_len", default=0, type=int)
